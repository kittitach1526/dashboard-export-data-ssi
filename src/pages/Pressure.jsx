...
import { pressureService } from "../services/pressure_api";
...
//   const categories_power = ["Power (5.5)", "Power (6.5)", "Power (7)"];
  ...
  const fetchData_pressure_5_5 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureToday_5_5();
  ...
  const fetchData_pressure_Week_5_5 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureWeek_5_5();
  ...
  const fetchData_pressure_Month_5_5 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureMonth_5_5();
  ...
  //------------------------------------------------------------------------------------------------
    ...
    const fetchData_pressure_6_5 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureToday_6_5();
  ...
  const fetchData_pressure_Week_6_5 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureWeek_6_5();
  ...
  const fetchData_pressure_Month_6_5 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureMonth_6_5();
  ...
  //------------------------------------------------------------------------------------------------
    ...
    const fetchData_pressure_7 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureToday_7();
  ...
  const fetchData_pressure_Week_7 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureWeek_7();
  ...
  const fetchData_pressure_Month_7 = async () => {
    setLoading(true);
    try {
      const result = await pressureService.getPressureMonth_7();
  ...
  useEffect(() => {
    if (category === "Pressure (5.5)" && timePreset === "today") {
      fetchData_pressure_5_5();
    } else if (category == "Pressure (5.5)" && timePreset == "week") {
      fetchData_pressure_Week_5_5();
    }else if (category == "Pressure (5.5)" && timePreset == "month") {
      fetchData_pressure_Month_5_5();
    }

    else if (category === "Pressure (6.5)" && timePreset === "today") {
      fetchData_pressure_6_5();
    } else if (category == "Pressure (6.5)" && timePreset == "week") {
      fetchData_pressure_Week_6_5();
    }else if (category == "Pressure (6.5)" && timePreset == "month") {
      fetchData_pressure_Month_6_5();
    }

    else if (category === "Pressure (7)" && timePreset === "today") {
      fetchData_pressure_7();
    } else if (category == "Pressure (7)" && timePreset == "week") {
      fetchData_pressure_Week_7();
    }else if (category == "Pressure (7)" && timePreset == "month") {
      fetchData_pressure_Month_7();
    }
